...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cappuDice = __webpack_require__(160);

	var _cappuDice2 = _interopRequireDefault(_cappuDice);

	var _Dice = __webpack_require__(161);

	var _Dice2 = _interopRequireDefault(_Dice);

	var _DiceViewer = __webpack_require__(162);

	var _DiceViewer2 = _interopRequireDefault(_DiceViewer);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.state = {
	      currentDice: null,
	      dices: [new _cappuDice2.default(6), new _cappuDice2.default(8), new _cappuDice2.default(10), new _cappuDice2.default(12), new _cappuDice2.default(20)]
	    };

	    _this._selectDice = _this._selectDice.bind(_this);
	    return _this;
	  }

	  _createClass(App, [{
	    key: '_selectDice',
	    value: function _selectDice(dice) {
	      var _this2 = this;

	      return function () {
	        _this2.setState({ currentDice: dice });
	      };
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      if (this.state.currentDice) {
	        diceViewer = _react2.default.createElement(_DiceViewer2.default, { dice: this.state.currentDice });
	      }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          null,
	          this.state.dices.map(function (d, i) {
	            var selected = _this3.state.currentDice === d;
	            return _react2.default.createElement(_Dice2.default, { dice: d, key: i, onClick: _this3._selectDice(d), selected: selected });
	          })
	        ),
	        diceViewer
	      );
	...
	!function (root, undefined) {
	  ...
	  Dice.prototype = {
	    ...
	    roll: function roll(times) {
	      ...
	      for (i = 0; i < t; i++) {
	        res.push(Math.floor(this._random() + this.getModsSum() + this.getTmpModsSum()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dice = function (_React$Component) {
	  ...
	  _createClass(Dice, [{
	    ...
	    get: function get() {
	      return {
	        dice: _react2.default.PropTypes.instanceOf(_cappuDice2.default).isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DiceViewer = function (_React$Component) {
	  _inherits(DiceViewer, _React$Component);

	  _createClass(DiceViewer, null, [{
	    key: 'propTypes',
	    get: function get() {
	      return {
	        dice: _react2.default.PropTypes.instanceOf(_cappuDice2.default).isRequired
	  ...
	  function DiceViewer(props) {
	    _classCallCheck(this, DiceViewer);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DiceViewer).call(this, props));
	    ...
	    _this._go = _this._go.bind(_this);
	    _this._handleMods = _this._handleMods.bind(_this);
	    _this._handleTmpMods = _this._handleTmpMods.bind(_this);
	    _this._handleTimes = _this._handleTimes.bind(_this);
	    _this._eraseTimes = _this._eraseTimes.bind(_this);
	    return _this;
	  }

	  _createClass(DiceViewer, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(props) {
	      this.state.tmpMods = props.dice.tmpMods.map(function (v) {
	        return v.val;
	      });
	    ...
	    value: function _go() {
	      ...
	      var results = this.props.dice.roll(this.state.times);

	      if (parseInt(this.state.times, 10) === 1) {
	        results = [results];
	      }

	      this.setState({ results: results, tmpMods: '' });
	    }
	  }, {
	    key: '_handleMods',
	    value: function _handleMods(e) {
	      var _this2 = this;

	      this.props.dice.resetMods();

	      var values = e.target.value.split(',').map(function (v) {
	        return v.trim();
	      });
	      values.forEach(function (v) {
	        if (!!v.trim()) {
	          _this2.props.dice.addMod(parseInt(v, 10));
	        }
	      });
	    ...
	    key: '_handleTmpMods',
	    value: function _handleTmpMods(e) {
	      var _this3 = this;
	      ...
	      values.forEach(function (v) {
	        if (!!v.trim()) {
	          _this3.props.dice.addTmpMod(parseInt(v, 10), parseInt(_this3.state.times, 10));
	        }
	      });
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'dice-viewer' },
	        _react2.default.createElement(
	          'div',
	          { className: 'dice-viewer-side' },
	          _react2.default.createElement(
	            'h2',
	            { className: 'dice-viwer-name' },
	            'D',
	            dice.sides
	          ),
	          this._getResults()
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'button', id: 'dice-go', onClick: this._go, value: 'Go!' })
	          )
	        )
	      );
	    }
